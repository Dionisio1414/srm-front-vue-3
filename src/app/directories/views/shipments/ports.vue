<template>
  <directories-table
    ...
    :storage-key="STORAGE_KEYS.PORT_PORTS_COLUMNS"
    :fields="PORT_PORTS_FIELDS"
  >
...
const { isLoading, data, getData } = useGetData('ports', infoStore.getPorts);
