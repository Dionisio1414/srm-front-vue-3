<template>
  <directories-table
    ...
    :storage-key="STORAGE_KEYS.SHIPMENTS_SIZES_COLUMNS"
    :fields="SHIPMENTS_SIZES"
  >
    <template #waysFilter="{ exportData, updatedFilter, resetFiltersHandler, filters }">
      ...
      >
        ...
        <span class="text-lg">
          {{ $t('directories.buttons.newTUSize') }}
        </span>
      </prime-button>
...
const { isLoading, data, getData } = useGetData('unitSizes', infoStore.getUnitSizes);
